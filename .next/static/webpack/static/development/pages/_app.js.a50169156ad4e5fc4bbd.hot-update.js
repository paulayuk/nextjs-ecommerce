...
function (_App) {
  ...
  function MyApp() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this), "addToCart", function (product) {
      _this.setState({
        cart: [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_this.state.cart), [product])
      });

      localStorage.setItem('cart', _this.state.cart);
      console.log(_this.state.cart);
    });
...
//# sourceMappingURL=_app.js.a50169156ad4e5fc4bbd.hot-update.js.map